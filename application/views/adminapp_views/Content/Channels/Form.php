	    ...
	    <div class="col-md-12">
	        ...
	        <div class="panel panel-inverse" data-sortable-id="form-validation-2">
	            ...
	            <div class="panel-body panel-form">
	                <form class="form-horizontal form-bordered" data-parsley-validate="true" method="POST" action="<?= base_url('adminapp/Content/Channels/Store') ?>">
						<div class="form-group">
							<label class="control-label col-md-4 col-sm-4">Channel :</label>
							<div class="col-md-6 col-sm-6">
								<input class="form-control" type="text" id="name" name="name" placeholder="Channel" data-parsley-required="true" value="<?= $action == 'edit' ? $channel->name : '' ?>" required />
							</div>
						</div>
						<div class="form-group">
